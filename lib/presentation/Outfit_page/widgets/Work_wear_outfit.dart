...
import 'package:firebase_storage/firebase_storage.dart' as firebase_storage;
import 'package:sdgp_test01/presentation/Firebase_loader/firebase_loader.dart';

class Work_wear_outfit extends StatefulWidget {
  final Function(String)? onImageSelected; // Callback for image selection
  const Work_wear_outfit({Key? key, this.onImageSelected}) : super(key: key);

  @override
  Work_wear_outfitState createState() => Work_wear_outfitState();
}

class Work_wear_outfitState extends State<Work_wear_outfit> {
