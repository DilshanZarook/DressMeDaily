...
class _Searchbar_pageState extends State<Searchbar_page>
  ...
  void _navigateToBottomSheet(BuildContext context, String selection) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (_) => Search_output()));
  }
                  ...
                  children: [
                    Expanded(
                      child: TextField(
                        ...
                        onSubmitted: (_) =>
                            _onSearchSubmitted(), // Adjust as per your theme
                      ),
                    ),
                    IconButton(
                      icon: SvgPicture.asset(
                          'assets/images/img_searchnormal.svg'),
                      // Replace with your icon path
                      onPressed: () => _navigateToBottomSheet(
...
class _Search_outputState extends State<Search_output> {
  List<ItemModel> items =
      List.generate(20, (_) => ItemModel()); // Assuming ItemModel is defined
