...
class Frame720PageState extends State<Frame720Page>
    with AutomaticKeepAliveClientMixin<Frame720Page>, SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    super.build(context); // Call to super.build is required when using AutomaticKeepAliveClientMixin
    return  Scaffold(
        ...
        children: [
          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: Color(0xFFFFE5B4), // Peach color
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                _showWardrobeNamePopup(context);
              },
              child: DottedBorder(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Frame851TabContainerScreen()),
                    );
                  },
                  child: Container(
                    width: 68.h,
