        ...
        children: [
          ...
          Column(
            children: [
              ...
              Stack(
                alignment: Alignment
                    .topCenter, // Aligns children relative to the top-center of the stack
                children: [
                  Container(
                    margin: EdgeInsets.only(
                      left: 25.h,
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.only(
                        ...
                        topRight: Radius.circular(
                            50), // Applying a border radius of 50 to the top right corner
                        bottomLeft: Radius.circular(
                            0), // Keeping the bottom left corner radius as 0
          ...
          Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment
                  .spaceBetween, // This will position the children at the start and end of the row
              children: [
                AppbarTitle(
                  text: "DMD",
                ...
                GestureDetector(
                    ...
                    child: Container(
                      margin: const EdgeInsets.only(
                          bottom: 10.0), // Bottom margin of 10
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment:
                MainAxisAlignment.spaceEvenly, // Adjusted for even spacing
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // Image button 1
              InkWell(
