...
class Frame648Screen extends StatelessWidget {
  const Frame648Screen({Key? key}) : super(key: key);
  ...
  /// Displays a dialog with the [Frame651Dialog] content.
  onTapPurchased(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => AlertDialog(
              content: Frame651Dialog(),
