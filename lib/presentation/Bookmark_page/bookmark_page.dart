  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius:
            BorderRadius.circular(20), // Assuming 20 is the desired radius
      ),
      child: Text(
        title,
...
class Bookmark_page extends StatelessWidget {
  ...
  Widget _buildFrameList(BuildContext context) {
    ...
    List<Widget> frames = [
      const Frame404Bottomsheet(),
      // Replace with your actual screen widget for frame_1
      const Frame405Bottomsheet(),
      // Replace with your actual screen widget for frame_2
      const Frame406Bottomsheet(),
      // Replace with your actual screen widget for frame_3
        ...
        children: List.generate(titles.length, (index) {
          return Column(
            children: [
              ...
              if (index <
                  titles.length -
                      1) // Add space between items, except after the last one
