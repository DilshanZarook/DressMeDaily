...
import 'package:sdgp_test01/widgets/custom_image_view.dart';
...
class Frame1038Screen extends StatelessWidget {
                                                  ...
                                                  .copyWith(
                                                      borderRadius:
                                                          BorderRadiusStyle
                                                              .roundedBorder50),
                                              child: Container(
                                                height: 55.v, // Adjust height as needed
                                                width: 60.h, // Adjust width as needed
                                                alignment: Alignment.center,
                                                child: Image.asset(
                                                  ImageConstant.imgUserGray50001, // Path to your image asset
                                      ...
                                      Padding(
                                          ...
                                          child: CustomIconButton(
                                              ...
                                              child: Container(
                                                ...
                                                child: Image.asset(
                                                  ImageConstant.imgUserGray5000155x56, // Path to your image asset
                                ...
                                Padding(
                                  ...
                                  child: CustomIconButton(
                                    ...
                                    onTap: () {
                                      ...
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context) => Frame1061Page()),
                                      );
                                    },
                                    child: Container(
                                      child: Image.asset(
                                        ImageConstant.imgAlarm, // Path to your image asset
                                        fit: BoxFit.cover, // This is optional, depending on how you want the image to fit
                                      ),
                                    )
                                  ),
                                ),
    ...
    return Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Container(
            ...
            width: 35.adaptSize,   // Adjust width as needed
            child: Image.asset(
              ImageConstant.imgFilledAppointmentReminders,  // Path to your image asset
              fit: BoxFit.cover,       // Adjust the fit as per your requirement
            ),
          ),
          Padding(
  ...
  Widget _buildFrame5(BuildContext context) {
    return Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Container(
              height: 34.v, width: 41.h,
            child:Image.asset(ImageConstant.imgFrame114,fit: BoxFit.cover,) ),
          Padding(
  ...
  Widget _buildFrame(
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      ...
      Container(
        height: 31.v,  // Adjust the height as needed
        width: 39.h,   // Adjust the width as needed
        margin: EdgeInsets.only(top: 4.v, bottom: 3.v),  // Set the desired margins
        child: Image.asset(
          ImageConstant.imgMegaphone,  // Path to your image asset
          fit: BoxFit.cover,           // This is optional, you can adjust as per your need
        ),
      )
