...
class _Frame4ItemWidgetState extends State<Frame4ItemWidget> {
  ...
  final allClothesOptions = ['All Clothes', 'Jeans', 'Shirt', 'Skirt'];
  final seasonOptions = ['Season', 'Spring', 'Summer', 'Fall', 'Winter'];
  final occasionOptions = ['Occasion', 'Casual', 'Formal', 'Party', 'Sport'];
  ...
  Widget build(BuildContext context) {
    return Theme(
      ...
      child: Wrap(
        ...
        children: [
          createDropdownButton("All Clothes", selectedAllClothes, allClothesOptions),
          SizedBox(width: 5.v),
