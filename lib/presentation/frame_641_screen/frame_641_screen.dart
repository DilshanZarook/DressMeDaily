...
class Frame641Screen extends StatelessWidget {
  const Frame641Screen({Key? key}) : super(key: key);
        ...
        title: Column(children: [
          ...
          Padding(
              ...
              child: Row(children: [
                ...
                AppbarSubtitleFour(
                    text: "Subscription",
                    margin: EdgeInsets.only(left: 95.h, top: 9.v, bottom: 7.v))
              ])),
