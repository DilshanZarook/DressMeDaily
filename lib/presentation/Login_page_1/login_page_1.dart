...
class Login_page_1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
            ...
            padding: EdgeInsets.symmetric(horizontal: 36.h, vertical: 183.v),
            child:
                Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              SizedBox(
                width: 300
                    .h, // Ensure .h is a valid extension method for your context
                child: Text(
                  ...
                  style: (theme.textTheme.bodyLarge
                      ...
                      TextStyle(
                          fontSize: 24
                              .v), // Provide a default style if bodyLarge is null
                ),
              ),
              Spacer(),
              ...
              GestureDetector(
                ...
                child: Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment
                      .center, // Aligns the icon vertically with the text
                  children: [
                    Text(
                      "Other options",
                    ...
                    SvgPicture.asset(
                      ...
                      height: theme.textTheme.titleLarge!
                          .fontSize, // Match the text size
                      width: theme.textTheme.titleLarge!
                          .fontSize, // Match the text size
                    ),
                  ],
                ),
  ...
  /// Navigates to the GOOGLE_SIGNIN when the action is triggered.
