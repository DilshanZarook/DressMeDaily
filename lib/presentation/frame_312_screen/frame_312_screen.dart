...
class Frame312Screen extends StatelessWidget {
  const Frame312Screen({Key? key})
      : super(
          key: key,
        );
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Frame624Screen()), // Replace Frame624 with the actual widget class for frame 624
                    );
                  },
                  child: Container(
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Frame312Screen()), // Replace with your actual screen widget
                  );
                },
                child: CustomImageView(
